# Unity3D-Documentation-Template
Project containing a template for Unity3D Project Documentation automated generation based of Docfx for Windows based OS

## Key Features
- Generic template for setting up your Unity3D Project Documentation using DocFX
- Quick setup may help in team adoption
- Powershell scripts allow quick update and preview of documentation site
- Includes automated support for linking and converting Draw.IO/Diagrams.net diagrams to .svg
- Includes automated support for nesting code coverage data (outputted from the Unity3D Code coverage package)
...
- (2) Copy the 'Documentation' folder into your Unity3D Project folder (next to the 'Assets' folder)
- (3) Preview the documentation template using the PowerShell scripts as described below:
